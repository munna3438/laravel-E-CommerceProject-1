                        ...
                        <div class="box">
                            <div class="option_container">
                                <div class="options">
                                    ...
                                    <a href="{{ route('cart.store', $product->id) }}" class="option2">
                                        add to cart
                                    </a>
                                </div>
                            </div>
                            <div class="img-box">
                                <img src="{{ asset('upload/product-image/' . $product->image) }}" alt="">
                            </div>
                            <div class="">
                                <h5>
                                    {{ $product->title }}
                                ...
                                <h6>
                                    @if ($product->discount_price)
                                        <p class="text-red-500">৳ {{ $product->discount_price }}</p>
                                        <p class="text-[#333] line-through">৳ {{ $product->price }}</p>
                                    @else
